...
namespace SprintUI2.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idCliente,nome,email,senha,dataNascimento,saldo")] ClienteModel clienteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idCliente,nome,email,senha,dataNascimento,saldo")] ClienteModel clienteModel)
        {
